            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <form id="accountForm" name="accountForm" action="{{ url('/account') }}" method="POST">
                        ...
                        <input value="{{ $userDetails->zipcode }}" id="pincode" name="zipcode" type="text" placeholder="Zip Code">
                        ...
                        <input style="margin-top: 10px;" value="{{ $userDetails->mobile }}" id="mobile" name="mobile" type="text" placeholder="Mobile">
